...
* *shows*: Commands that deals with the management fo shows for the theatre.
* *seats*: Commands that deals with the management of seats within the theatre.
* *finance*: Commands that manages finances within the theatre.
* *parser*: Commands that deals with command aliases.
